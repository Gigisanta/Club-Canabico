...
- `npm run check`: typecheck, 62 pruebas aprobadas, 4 omitidas por falta de `TEST_DATABASE_URL` en esa ejecución y build correcto. `npm run test:e2e` en un esquema PostgreSQL desechable: **20/20 pruebas**; esquema eliminado al terminar. Incluye alta de lote y socio, venta, ficha, importación, roles, búsqueda, teclado, menú móvil y rutas profundas.
