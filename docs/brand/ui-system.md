...
- Escala de espacio: 4, 8, 12, 16, 24, 32, 48 y 72 px (`--space-1` a `--space-8`). Radios de 10, 14 y 20 px para controles, tarjetas y diálogos. En el panel, cuerpo de lectura de 16 px y texto auxiliar de al menos 14 px; títulos contenidos según el ancho disponible. Los módulos pueden reducir los títulos en móvil sin bajar el cuerpo de lectura.
...
- Navegación móvil: Inicio, Ventas, Stock, Socios y Más según el rol. Más muestra los seis grupos del panel con sus opciones permitidas. En escritorio se abre un solo grupo a la vez; la página actual abre el suyo. No se modifican permisos ni rutas profundas existentes.
